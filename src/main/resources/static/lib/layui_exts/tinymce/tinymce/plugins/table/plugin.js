...
(function (domGlobals) {
    ...
    var inAncestor = Immutable('ancestor', 'descendants', 'element', 'templates.index');
    var inParent = Immutable('parent', 'children', 'element', 'templates.index');
