...
<div style="width: ${vo.getWidth()?c}%; height: ${(vo.getHeight() * 50)?c}px; position: absolute; top: ${(vo.getY() * 50)?c}px; left: ${(vo.getX())?c}%; padding: 15px;">
    <dv-border-box-8>
        ...
        <#if vo.getWidgetId()??>
            <div id="${'component_' + vo.getWidgetId()}" class="chart" style="width:100%;height: ${(vo.getHeight() * 50 - 70)?c}px;"></div>
        <#else>
