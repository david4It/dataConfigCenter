...
<script type="text/javascript">
    let app = new Vue({
        ...
        methods: {
            <#list components as vo>
                <#switch vo.getType()>
                    <#case "bar"><#include "preview_bar.ftl"><#break>
                    <#case "line"><#include "preview_line.ftl"><#break>
                    <#case "pie"><#include "preview_pie.ftl"><#break>
                    <#case "radar"><#include "preview_radar.ftl"><#break>
