...
public class HTMLTemplateUtil {
    ...
    private static final String PREVIEW_FREEMARKER_DIR = "/templates/preview/freemarker/";
    ...
    public static void deleteHTMLFile(Long layoutId, String url, LayoutMapper layoutMapper, Boolean isPreview) throws Exception {
        File file = new File(new ClassPathResource(isPreview ? TEMPLATES_DIR : PREVIEW_TEMPLATES_DIR).getURI().getPath() + url + HTML_SUFFIX);
        file.delete();
    ...
    public static void generateHTMLFile(LayoutVO layout, LayoutMapper layoutMapper, Boolean isPreview) throws Exception {
        ...
        configuration.setDirectoryForTemplateLoading(new File(new ClassPathResource(isPreview ? FREEMARKER_DIR : PREVIEW_FREEMARKER_DIR).getURI().getPath()));
        ...
        File file = new File(new ClassPathResource(isPreview ? TEMPLATES_DIR : PREVIEW_TEMPLATES_DIR).getURI().getPath() + layout.getUrl() + HTML_SUFFIX);
        file.delete();
